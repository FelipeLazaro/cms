...
class GestorSlide{
	...
	public static function editorSlideController(){
	...
	#-----------------------------------------------------------
	public static function eliminarSlideController($datos){
	...
	public static function actualizarSlideController($datos){
