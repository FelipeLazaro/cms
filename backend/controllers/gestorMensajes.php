...
class MensajesController{
	...
	public static function borrarMensajesController(){
	...
	#RESPONDER MENSAJES
	#------------------------------------------------------------
	public static function responderMensajesController(){
	...
	#------------------------------------------------------------
	public static function mensajesMasivosController(){
	...
	#------------------------------------------------------------
	public static function mensajesSinRevisarController(){
